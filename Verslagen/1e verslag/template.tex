...
The user logs into his Infrastructure Owner dashboard and selects the option to edit his buildings' topology. When the user is done editing the topology, the updated topology will be saved in the Online Service.
...
\begin{itemize}
    ...
    \item \textbf{Interested parties:} 
        \begin{itemize}
            ...
            \item \textit{Customer Organization:} (possible) wants to subscribe to application and is waiting for hardware for it to be deployed
        \end{itemize}
