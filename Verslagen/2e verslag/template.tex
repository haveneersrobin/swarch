...
\paragraph{Rationale}
M1 was chosen because it has high priority and because a lot of high priority usecases are linked to M1. Integrating a new sensor or actuator manufacturer is closely related to initialising and configuring the topology or any pluggable devices. For this reason, we chose M1, UC8, UC9, UC10 and UC13 as drivers. \todo{Beter uitschrijven.}
